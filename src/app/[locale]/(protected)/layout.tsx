  ...
  return (
    <DesktopNavigationShell>
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="box-border w-full min-w-0 max-w-full flex-1 pb-[calc(4rem+env(safe-area-inset-bottom,0px))] transition-[padding-left] duration-200 ease-out motion-reduce:transition-none md:pb-0 md:pl-[var(--desktop-navigation-width)]"
      >
        {children}
      </main>
    </DesktopNavigationShell>
