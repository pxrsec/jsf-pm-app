...
import { getAdminShellData } from "@/lib/shell-data/shell-queries";
...
export default async function AdminPage() {
  ...
  const data = await getAdminShellData(supabase);

  return <AdminShell profile={session.profile} data={data} />;
}
