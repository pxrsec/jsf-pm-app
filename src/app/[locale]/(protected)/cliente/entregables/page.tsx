...
import { getClientProductionReviewQueue } from "@/lib/client/queries";
import { ClientReviewList } from "./_components/client-review-list";
...
export default async function ClientReviewsPage({
  ...
  const reviews = await getClientProductionReviewQueue(supabase);
