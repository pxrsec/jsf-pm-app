...
| [x]     | J-04 | Demo Operator A, then Operator B; Spanish desktop               | Inspect Calendar and own Archive                                                                                                               | Operator A sees only assigned-task milestone **Sandbox Operator Checkpoint**. Project-scoped **Sandbox Project Review** and foreign-task milestones are absent. No incident/project/Drive expansion beyond authorization.                 | as operator a i dont see the "sandbox operator checkpoint" milestone in the calendar view, i dont see the "sandbox project review" either. maybe our bootstrap script didnt create those? same thing with operator b. | fail           |
...
| [x]     | J-07 | Demo Operator A; Spanish desktop                                | `/notificaciones`; exercise All/Read/Unread and a custom range covering 91–93 days                                                             | Default range has one unread and one read in-app fixture. Custom bounded range exposes one historic fixture. Mark-one/mark-all remain self-only. No queue/provider data appears. Suppression is truthfully terminal `provider_disabled`.  | 2 read notifications, 1 unread.  mark as read works as expected.                                                                                                                                                      | pass           |
